...
export default defineConfig({
  ...
  resolve: {
    ...
    // Without this, transitive deps can resolve their own React copy,
    // triggering "Invalid hook call" errors at runtime.
    ...
    rollupOptions: {
      output: {
        ...
        manualChunks: {
          ...
          // Motion lives in its own chunk so it can be cached independently
